...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Inyungu.controller.PeopleSearch": [],
  "Inyungu.controller.Products": [],
  "Inyungu.model.Product": [],
  "Inyungu.store.Products": [],
  "Inyungu.view.DetailPanel": [],
  "Inyungu.view.ListContainer": [],
  "Inyungu.view.Main": [],
  "Inyungu.view.MainNav": []
});
