...
CREATE TABLE IF NOT EXISTS `igu_image_product` (
  ...
  CONSTRAINT `igu_image_product_ibfk_1` FOREIGN KEY (`idclientproduct`) REFERENCES `igu_client_product` (`id`)
...
-- -------------------------------------------
INSERT INTO `igu_client_product` (`id`,`idproduct`,`idclient`,`currentprice`,`creationdate`,`quantity`,`totalamount`,`detail`) VALUES
('1','5','1','100','2014-02-07','100','75000','Amasaka yanjye urebye ni meza cyane.kuko ndayahingira nkayagirira isuku.Ngayo nguko');
INSERT INTO `igu_client_product` (`id`,`idproduct`,`idclient`,`currentprice`,`creationdate`,`quantity`,`totalamount`,`detail`) VALUES
('2','6','1','9000','2014-02-10','30','25000','Ihene zanjye ni nziza cne.');
INSERT INTO `igu_client_product` (`id`,`idproduct`,`idclient`,`currentprice`,`creationdate`,`quantity`,`totalamount`,`detail`) VALUES
('3','7','1','3000','2014-02-10','100','27000','Izi nkoko ni iza kizungu.Imwe ifite ibiro 3.');
INSERT INTO `igu_client_product` (`id`,`idproduct`,`idclient`,`currentprice`,`creationdate`,`quantity`,`totalamount`,`detail`) VALUES
('4','8','1','600000','2014-02-10','2','1100000','Ni izakijyambere.');
INSERT INTO `igu_client_product` (`id`,`idproduct`,`idclient`,`currentprice`,`creationdate`,`quantity`,`totalamount`,`detail`) VALUES
('5','7','1','800','2014-02-10','100','45000','ok');
...
('15','733398105-hotel55.jpg','1');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('16','189636940-hotel55.jpg','1');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('17','447338088-hotel5.jpg','1');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('18','699534642-ihene.jpg','2');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('19','449614362-inkoko.jpg','3');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('20','476359552-inka.jpg','4');
INSERT INTO `igu_image_product` (`id`,`image`,`idclientproduct`) VALUES
('21','767617818-inkoko.jpg','5');
...
('12','1','2014-02-07','524906857674','0');
...
-- -------------------------------------------
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('1','Uwamahoro','Denyse','0788654327','2014-01-29','cyri@yahoo.fr','1','kirehe','1233456789','2','10','My own','3');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('2','ntabana','coco','08788654321','2014-01-30','kamanzi@yahoo.fr','1','ruhondo','987654321','1','1','Webtech','2');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('3','kamanzi','koko','987665','2014-01-31','cntaba@yahoo.fr','1','ujo','09887765','3','1','rssb','16');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('4','umulisa','musope','087797653','2014-02-05','udenyse@gmail.com','1','karama','1198763300981','1','1','abasaruzi','30');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('5','uwayo','florentine','0788565456','2014-02-05','udenyse@gmail.com','3','karama','1198763300981','1','1','abasaruzi','9');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('6','cyuda','cyuda','078887655431','2014-02-05','cntaba@yahoo.fr','1','kabatsi','08766543221','3','5','cyuda','31');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('7','iyamuremye','claude','0788646474','2014-02-05','udenyse@gmail.com','2','KARUGIRa','1198723400981','1','1','KUGURA','32');
INSERT INTO `igu_registration` (`id`,`firstname`,`lastname`,`telephone`,`datedinscription`,`email`,`iddistrict`,`sector`,`identite`,`idcompanytype`,`numberofmembers`,`nameofcooperative`,`iduser`) VALUES
('8','sebikoro','disimasi','0738344567','2014-02-05','udenyse@gmail.com','4','karama','1198763300981','1','1','sebikoro','34');
...
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56776','659527626769','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56777','300275781510','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56778','725658594845','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56779','460024465450','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56780','395239742925','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56781','585420571015','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56782','328104638488','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56783','645371789195','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56784','181855404541','0','4');
INSERT INTO `igu_voucher` (`id`,`vouchernumber`,`status`,`idcredit`) VALUES
('56785','617569452927','0','4');



-- -------------------------------------------
-- TABLE DATA igu_voucher_management
-- -------------------------------------------
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('64','3','56723','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('65','3','56724','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('66','3','56623','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('67','3','56624','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('68','3','56625','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('69','3','56626','0000-00-00 00:00:00','2014-02-03');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('70','5','56627','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('71','5','56628','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('72','5','56629','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('73','5','56630','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('74','5','56631','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('75','4','56632','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('76','4','56633','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('77','4','56634','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('78','4','56635','0000-00-00 00:00:00','2014-02-05');
INSERT INTO `igu_voucher_management` (`id`,`idagent`,`idvoucher`,`useddate`,`givendate`) VALUES
('79','4','56636','0000-00-00 00:00:00','2014-02-05');
...
('2','ntabana','7afc1e8d73aa86fa1bd39136df5eab56','1','52e68aa7b447b6.44672633');
INSERT INTO `user` (`id`,`username`,`password`,`status`,`salt`) VALUES
('3','dedy','aae3197a705123eb4b35b0cff2727c8f','1','52e69b23909831.79881496');
INSERT INTO `user` (`id`,`username`,`password`,`status`,`salt`) VALUES
